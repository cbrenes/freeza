...
class URLDetailRouter: NSObject, URLDetailDataPassing {
  ...
  //func navigateToSomewhere(source: URLDetailViewController, destination: SomewhereViewController)
  //{
  ...
  //func passDataToSomewhere(source: URLDetailDataStore, destination: inout SomewhereDataStore)
  //{
